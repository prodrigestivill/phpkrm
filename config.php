...
$dbpic="img/";	//Where are saved all pictures
$dbgenpath="weboftrust/"; //Where are saved pictures of web of trust.
$dbphoto="photo/"; //Where are saved users photos.
$dblogo="logo/"; //Where are saved keyrings logos.
