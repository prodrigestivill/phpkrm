...
Install
    ...
    * Create empty files in the previous folder with the name of keyrings
          o The keyring name must be only alphanumeric and/or the characters -_
          o Files must be owned by www user 
...
Customizations
    ...
    * Using reCAPTCHA (Anti-SPAM method)
          o Download and save recaptchalib.php in the same folder as index.php.
          o Configure $recaptcha_* variables with the reCAPTCHA mail keys and form keys. 
